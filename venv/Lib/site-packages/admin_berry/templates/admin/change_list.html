                            ...
                            <tbody>
                                {% for obj in cl.result_list %}
                                    <tr>
                                        ...
                                        <td>{{ obj.ci }}</td>
                                        <td>
                                            <a href="{% url 'admin:web_vecino_change' obj.pk %}" class="action-edit" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{% url 'admin:web_vecino_delete' obj.pk %}" class="action-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este objeto?');" title="Eliminar">
