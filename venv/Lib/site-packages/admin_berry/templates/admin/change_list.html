                            ...
                            <tbody>
                                {% for obj in cl.result_list %}
                                    <tr>
                                        ...
                                        <td>{{ obj.name }}</td>
                                        <td>
                                            <a href="{% url 'admin:auth_group_change' obj.pk %}" class="action-edit" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{% url 'admin:auth_group_delete' obj.pk %}" class="action-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este objeto?');" title="Eliminar">
