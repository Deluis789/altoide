                        ...
                        <div class="card-title">
                            {% if perms_lacking %}
                                ...
                                <div class="{{ direction.panel }}">
                                    <blockquote>
                                        <ul class="blockquote blockquote-primary border-0">
                            ...
                            {% else %}
                                <p class="txt-left-dir">
                                    {% blocktrans %}
                                    ¿Estás seguro de que deseas eliminar el {{ objects_name }} seleccionado? Todos los objetos siguientes y sus elementos relacionados serán eliminados:"
                                    {% endblocktrans %}
                                </p>
                            {% endif %}
                        </div>
                        ...
                        {% if not perms_lacking and not protected %}
                            ...
                            <form method="post">
                                ...
                                <div>
                                    ...
                                    <a href="{% url opts|admin_urlname:'changelist' %}" class="btn btn-sm btn-warning">{% trans "No llevame atras" %}</a>
                                </div>
                            </form>
                        {% endif %}
                    </div>
