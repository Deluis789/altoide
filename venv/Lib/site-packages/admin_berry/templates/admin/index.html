...
{% block title %} Riesgo {% endblock title %}
{% block content %}
  <!-- [ Main Content ] start -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card bg-secondary-dark dashnum-card text-white overflow-hidden">
            ...
            <div class="card-body">
              ...
              <p class="mb-0 opacity-50">Total pendientes</p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-md-6">
                ...
                <div class="tab-pane show active" id="chart-tab-home" role="tabpanel" aria-labelledby="chart-tab-home-tab" tabindex="0">
                  <div class="row">
                    <div class="col-6">
                      ...
                      <p class="mb-0 opacity-50">Total de atenciones</p>
                    </div>
                    <div class="col-6">
          ...
          <div class="card bg-primary-dark dashnum-card dashnum-card-small text-white overflow-hidden">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                ...
                <div class="ms-2">
                  <h4 class="text-white mb-1">203 <i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                  <p class="mb-0 opacity-50 text-sm">Zonas</p>
                </div>
              </div>
            </div>
          </div>
          <div class="card dashnum-card dashnum-card-small overflow-hidden">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                ...
                <div class="ms-2">
                  <h4 class="mb-1">550 <i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                  <p class="mb-0 opacity-50 text-sm">Avenidas</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center">
                <a href="#!" class="b-b-primary text-primary">Ver todo <i class="ti ti-chevron-right"></i></a>
              </div>
            </div>
          </div>
        </div>
