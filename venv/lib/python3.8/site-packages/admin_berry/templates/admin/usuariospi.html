                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>Ci</th>
                                    <th>Rol</th>
                                    <th>Zonas/Urbanizaciones</th>
                                    <th>Calles/Avenidas</th>
                            ...
                            <tbody>
                                {% for obj in cl.result_list %}
                                    <tr>
                                        ...
                                        <td>{{ obj.Zona_urb }}</td>
                                        <td>{{ obj.Calle_av }}</td>
                                        <td>{{ obj.numero_vivienda }}</td>
                                        <td>
                                            <a href="{% url 'admin:web_usuariosp_change' obj.pk %}" class="action-edit" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{% url 'admin:web_usuariosp_delete' obj.pk %}" class="action-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este objeto?');" title="Eliminar">
