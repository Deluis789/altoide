                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>Longitud</th>
                                    <th>Maquinaria</th>
                                    <th>Técnico Supervisor</th>
                                    <th>Cuadrilla</th>
                                    <th>Volumen de Trabajo</th>
                                    <th>Descipcion del Trabajo</th>
                                    <th>Foto Inicio</th>
                                    <th>Foto en Desarollo</th>
                                    <th>Foto Culminado</th>
                                    <th>Acciones</th>
                            ...
                            <tbody>
                                {% for obj in cl.result_list %}
                                    <tr>
                                        ...
                                        <td>{{ obj.codigo.codigo_usuario}}</td>
                                        <td>{{ obj.distrito }}</td>
                                        <td>{{ obj.zonaurb }}</td>
                                        <td>{{ obj.estado}}</td>
                                        <td>{{ obj.fecha }}</td>
                                        <td>{{ obj.latitud }}</td>
                                        <td>{{ obj.longitud }}</td>
                                        <td>{{ obj.maquinaria }}</td>
                                        <td>{{ obj.tecnico_supervisor }}</td>
                                        <td>{{ obj.cuadrilla }}</td>
                                        <td>{{ obj.volumen }}</td>
                                        <td>{{ obj.descripcion_trabajo }}</td>
                                        <td>{{ obj.foto_inicio }}</td>
                                        <td>{{ obj.foto_desarollo }}</td>
                                        <td>{{ obj.foto_culminado }}</td>
                                        <td>
                                            <a href="{% url 'admin:web_fichaoperativa_change' obj.pk %}" class="action-edit" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{% url 'admin:web_fichaoperativa_delete' obj.pk %}" class="action-delete" onclick="return confirm('¿Estás seguro de que deseas eliminar este objeto?');" title="Eliminar">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{% url 'web:ficha_operativa_pdf' obj.pk %}" class="action-pdf" title="Generar PDF">
